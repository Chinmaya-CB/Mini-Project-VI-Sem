...
<html lang="en">
   ...
   <body>
      <section class="mt-3">
         ...
         <h4 class="text-center" style="color:green"> MeduBook Billing System </h4>
         <h6 class="text-center"> New Horizon College of Engineering</h6>
                     ...
                     <tr>
                        ...
                        <td style="width:60%">
                           <select name="vegitable" id="vegitable"  class="form-control">
                             ...
                             class="vegitable custom-select" data-quantity="<?php echo $row['quantity']; ?>">
                             <?php echo $row['name']; ?>
                                </option>
                              </option>
                              <?php  }?>   
...
<script>
   $(document).ready(function(){
     ...
     $('#add').on('click',function(){
        ...
        var selectedOption = $('#vegitable option:selected');
        var availableQty = selectedOption.data('quantity');

      if (parseInt(qty) > parseInt(availableQty)) {
       var errorMsg = '<span class="alert alert-danger ml-5">Entered quantity exceeds available quantity.</span>';
